...
public class ProductDAO {
	...
	public String getDate_a() {		// 현재 시간 리턴
	...
	public String getPeriod(String date_b) {
		...
		if (second < 0) {
			period = "경매마감!!";
				...
				period = Integer.toString(restMin) + "분 " + Integer.toString(restSec) + "초 남음";
			}else if (day < 1) {
				period = Integer.toString(restHour) + "시간 " + Integer.toString(restMin) + "분 남음";
			}else {
				period = Integer.toString(day) + "일 " + Integer.toString(restHour) + "시간 남음";
			}
