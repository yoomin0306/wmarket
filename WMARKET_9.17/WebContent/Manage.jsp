...
<ul class="list-group list-group-horizontal">
  ...
  <li class="list-group-item list-group-item-secondary" style="width:11rem">전화번호</li>
...
for(int i = 0; i < userList.size(); i++) {
	...
	<ul class="list-group list-group-horizontal">
	  ...
	  <li class="list-group-item" style="width:11rem"><%=phone %></li>
...
<ul class="list-group list-group-horizontal">
  ...
  <li class="list-group-item list-group-item-secondary" style="width:14rem">경매 마감</li>
...
<%
	...
	for(int i = 0; i < productList.size(); i++) {
		...
		<ul class="list-group list-group-horizontal">
		  ...
		  <li class="list-group-item" style="width:14rem"><%=date_b.substring(0, 16) %></li>
...
<%
	...
	for(int i = 0; i < productList3.size(); i++) {
		...
		<ul class="list-group list-group-horizontal">
		  ...
		  <li class="list-group-item" style="width:14rem"><%=date_b3.substring(0, 16) %></li>
